...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Veiculo</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{veiculo.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Cod:"/>
                    <h:inputText id="cod" value="#{veiculo.veiculo.cod}" title="Cod" required="true" requiredMessage="The cod field is required." />
                ...
                <br />
                <h:commandLink action="#{veiculo.create}" value="Create"/>
                <br />
                <br />
